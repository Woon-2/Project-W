...
public:
    ...
    virtual void update(float dt, Room& room, PlatoonLeader& leader) override;
...
private:
    ...
    void MU_CALLCONV moveBossToward( PlatoonLeader& leader, mu::Vec3 targetPos, float speedMult, float dt ) const;
