...
void Game::setupTacticalZoneIntroUI() {
	if (tacticalZoneIntroRoot_) return;

	tacticalZoneIntroRoot_ = static_cast<UI::Panel*>(
		uiManager_.root()->addChild(std::make_unique<UI::Panel>())
	);
	tacticalZoneIntroRoot_->name = "tacticalZoneIntro";
	tacticalZoneIntroRoot_->anchor = UI::Anchors::Center;
	tacticalZoneIntroRoot_->pivot = UI::Pivots::Center;
	tacticalZoneIntroRoot_->width = UI::DimValue::pct(100.f);
	tacticalZoneIntroRoot_->height = UI::DimValue::pct(100.f);
	tacticalZoneIntroRoot_->zOrder = 900;
	tacticalZoneIntroRoot_->visible = false;

	tacticalZoneIntroScrim_ = static_cast<UI::Panel*>(
		tacticalZoneIntroRoot_->addChild(std::make_unique<UI::Panel>())
	);
	tacticalZoneIntroScrim_->name = "tacticalZoneIntroScrim";
	tacticalZoneIntroScrim_->anchor = UI::Anchors::Center;
	tacticalZoneIntroScrim_->pivot = UI::Pivots::Center;
	tacticalZoneIntroScrim_->width = UI::DimValue::pct(140.f);
	tacticalZoneIntroScrim_->height = UI::DimValue::px(270.f);
	tacticalZoneIntroScrim_->drawSolidBackground = true;
	tacticalZoneIntroScrim_->colorTint = { 0.01f, 0.012f, 0.014f, 0.f };

	tacticalZoneIntroBanner_ = static_cast<UI::Image*>(
		tacticalZoneIntroRoot_->addChild(std::make_unique<UI::Image>())
	);
	tacticalZoneIntroBanner_->name = "tacticalZoneIntroBanner";
	tacticalZoneIntroBanner_->anchor = UI::Anchors::Center;
	tacticalZoneIntroBanner_->pivot = UI::Pivots::Center;
	tacticalZoneIntroBanner_->width = UI::DimValue::px(980.f);
	tacticalZoneIntroBanner_->height = UI::DimValue::px(327.f);
	tacticalZoneIntroBanner_->texture = assetManager_.tacticalZoneTitleBanner();
	tacticalZoneIntroBanner_->colorMul = { 0.035f, 0.04f, 0.045f, 0.f };
	tacticalZoneIntroBanner_->zOrder = 1;

	tacticalZoneIntroEmblem_ = static_cast<UI::Image*>(
		tacticalZoneIntroRoot_->addChild(std::make_unique<UI::Image>())
	);
	tacticalZoneIntroEmblem_->name = "tacticalZoneIntroEmblem";
	tacticalZoneIntroEmblem_->anchor = UI::Anchors::Center;
	tacticalZoneIntroEmblem_->pivot = UI::Pivots::Center;
	tacticalZoneIntroEmblem_->offsetX = UI::DimValue::px(-285.f);
	tacticalZoneIntroEmblem_->width = UI::DimValue::px(248.f);
	tacticalZoneIntroEmblem_->height = UI::DimValue::px(248.f);
	tacticalZoneIntroEmblem_->texture = assetManager_.hobgoblinEmblem();
	tacticalZoneIntroEmblem_->colorMul = { 1.f, 0.78f, 0.64f, 0.f };
	tacticalZoneIntroEmblem_->zOrder = 2;

	auto makeAccentLine = [&](const char* name, float offsetX) {
		auto* line = static_cast<UI::Panel*>(
			tacticalZoneIntroRoot_->addChild(std::make_unique<UI::Panel>())
		);
		line->name = name;
		line->anchor = UI::Anchors::Center;
		line->pivot = UI::Pivots::Center;
		line->offsetX = UI::DimValue::px(offsetX);
		line->offsetY = UI::DimValue::px(-70.f);
		line->width = UI::DimValue::px(92.f);
		line->height = UI::DimValue::px(2.f);
		line->drawSolidBackground = true;
		line->colorTint = { 0.85f, 0.20f, 0.12f, 0.f };
		line->zOrder = 3;
		return line;
	};
	tacticalZoneIntroLineLeft_ = makeAccentLine("tacticalZoneIntroLineLeft", -141.f);
	tacticalZoneIntroLineRight_ = makeAccentLine("tacticalZoneIntroLineRight", 281.f);

	tacticalZoneIntroCategory_ = static_cast<UI::Label*>(
		tacticalZoneIntroRoot_->addChild(std::make_unique<UI::Label>())
	);
	tacticalZoneIntroCategory_->name = "tacticalZoneIntroCategory";
	tacticalZoneIntroCategory_->anchor = UI::Anchors::Center;
	tacticalZoneIntroCategory_->pivot = UI::Pivots::Center;
	tacticalZoneIntroCategory_->offsetX = UI::DimValue::px(70.f);
	tacticalZoneIntroCategory_->offsetY = UI::DimValue::px(-70.f);
	tacticalZoneIntroCategory_->width = UI::DimValue::px(300.f);
	tacticalZoneIntroCategory_->height = UI::DimValue::px(44.f);
	tacticalZoneIntroCategory_->setText(L"전술 전투 구역 1");
	tacticalZoneIntroCategory_->setFontFamily(L"Malgun Gothic");
	tacticalZoneIntroCategory_->setFontSize(22.f);
	tacticalZoneIntroCategory_->setTextHAlign(UI::TextHAlign::Center);
	tacticalZoneIntroCategory_->setTextVAlign(UI::TextVAlign::Center);
	tacticalZoneIntroCategory_->setTextColor(0.72f, 0.70f, 0.66f, 1.f);
	tacticalZoneIntroCategory_->colorTint.a = 0.f;
	tacticalZoneIntroCategory_->zOrder = 4;

	tacticalZoneIntroTitle_ = static_cast<UI::Label*>(
		tacticalZoneIntroRoot_->addChild(std::make_unique<UI::Label>())
	);
	tacticalZoneIntroTitle_->name = "tacticalZoneIntroTitle";
	tacticalZoneIntroTitle_->anchor = UI::Anchors::Center;
	tacticalZoneIntroTitle_->pivot = UI::Pivots::Center;
	tacticalZoneIntroTitle_->offsetX = UI::DimValue::px(30.f);
	tacticalZoneIntroTitle_->offsetY = UI::DimValue::px(30.f);
	tacticalZoneIntroTitle_->width = UI::DimValue::px(440.f);
	tacticalZoneIntroTitle_->height = UI::DimValue::px(96.f);
	tacticalZoneIntroTitle_->setText(L"홉 고블린");
	tacticalZoneIntroTitle_->setFontFamily(L"Malgun Gothic");
	tacticalZoneIntroTitle_->setFontSize(56.f);
	tacticalZoneIntroTitle_->setTextHAlign(UI::TextHAlign::Center);
	tacticalZoneIntroTitle_->setTextVAlign(UI::TextVAlign::Center);
...
void Game::triggerTacticalZoneIntro(std::string_view arenaPrefix) {
	if (!tacticalZoneIntroRoot_) setupTacticalZoneIntroUI();
	if (!tacticalZoneIntroRoot_) return;
	...
	tacticalZoneIntroEmblem_->texture = emblem;
	tacticalZoneIntroEmblem_->colorMul = emblemColor;
	tacticalZoneIntroLineLeft_->colorTint = accentColor;
	tacticalZoneIntroLineRight_->colorTint = accentColor;
...
void Game::updateTacticalZoneIntro(float deltaTimeSec) {
	...
	tacticalZoneIntroScrim_->colorTint.a = 0.76f * globalAlpha;
	tacticalZoneIntroBanner_->colorMul.w = 0.94f * globalAlpha;
	tacticalZoneIntroEmblem_->colorMul.w = 0.62f * interval(0.12f, 0.62f) * fadeOut;
	tacticalZoneIntroLineLeft_->colorTint.a = 0.9f * lineAlpha;
	tacticalZoneIntroLineRight_->colorTint.a = 0.9f * lineAlpha;
	tacticalZoneIntroCategory_->colorTint.a = categoryAlpha;
	tacticalZoneIntroTitle_->colorTint.a = titleAlpha;

	const float bannerReveal = interval(0.f, 0.48f);
	tacticalZoneIntroBanner_->width = UI::DimValue::px(760.f + 220.f * bannerReveal);
	tacticalZoneIntroEmblem_->width = UI::DimValue::px(268.f - 20.f * interval(0.12f, 0.82f));
	tacticalZoneIntroEmblem_->height = tacticalZoneIntroEmblem_->width;
	tacticalZoneIntroCategory_->offsetY = UI::DimValue::px(-62.f - 8.f * categoryAlpha);
	tacticalZoneIntroTitle_->offsetY = UI::DimValue::px(10.f - 12.f * titleAlpha);

	const float lineWidth = 92.f * interval(0.08f, 0.52f);
	tacticalZoneIntroLineLeft_->width = UI::DimValue::px(lineWidth);
	tacticalZoneIntroLineRight_->width = UI::DimValue::px(lineWidth);
