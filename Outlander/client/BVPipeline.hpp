...
// Bounding Volume Pipeline의 Dispatcher
...
namespace Detail {
	extern ComPtr<ID3D12Resource> staticVBCube;
	extern D3D12_VERTEX_BUFFER_VIEW staticVBViewCube;
	extern ComPtr<ID3D12Resource> staticIBCube;
	extern D3D12_INDEX_BUFFER_VIEW staticIBViewCube;
