...
const std::array<std::vector<AssetDesc>, 1> gAssetDescs = { { {
    ...
    AssetDesc{ AssetType::Texture, "FloorModel", resourcePath/"models"/"dragon"/"Floor_C.jpg"},
    AssetDesc{ AssetType::Texture, "FloorNormalMap", resourcePath/"models"/"dragon"/"Floor_N.jpg"},
    AssetDesc{ AssetType::Texture, "FloorSpecularMap", resourcePath/"models"/"dragon"/"Floor_S.jpg"},
    AssetDesc{ AssetType::MaterialTree, "DragonMaterialTree", resourcePath }
} } };
}   // namespace detail