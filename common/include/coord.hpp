 ...
 * @details As public methods is defined in this class,     
 * the methods are documented in here in spite of it is in detail namespace.
 * @note A coordinate primitive must have its base System.     
 * If you want to migrate the coordinate primitive to another System,     
 * create a new coordinate primitive with the new System or call CoordEntry::migrate.
 * @see coord::System coord::Pt3 coord::Vec3
 */
template <class Conc>
class CoordEntry {
protected:
...
public:
    ...
    /**
     * @brief Constructs a coordinate primitive with a base System and a value.
     ...
     * @brief Constructs a coordinate primitive with a base System and a value.
     * @param pSys The base System of the coordinate primitive.
     * @param x The x-coordinate of the coordinate primitive.
    ...
    /**
     * @brief Gets the value of the coordinate primitive,     
     * which represents the coordinate in the base System.
     * @return `mu::Vec3&` The reference of the value.
     * @see set
     */
     ...
     * @brief Gets the value of the coordinate primitive,     
     * which represents the coordinate in the base System.
     * @return `const mu::Vec3&` The reference of the value.
     * @see set
     */
    const mu::Vec3& get() const NOEXCEPT { return val_; }
    /**
     * @brief Sets the value of the coordinate primitive.    
     * The value is considered as the coordinate in the base System.
    ...
    /**
     * @brief Sets the value of the coordinate primitive with another coordinate primitive,     
     * which may have a different base System.     
     * The conversion regarding the coordinate system relativeness is performed automatically.
     * @param other The other coordinate primitive to set.
     * @see get
     */
    ...
    /**
     * @brief Represents the coordinate as in another System.
     * @param sys The System to represent the coordinate.
     * @return `mu::Vec3` The coordinate primitive's value represented for the given System.
     * @see coord::System
     */
    ...
    /**
     * @brief Represents the coordinate as in the base System.
     * Unlike CoordEntry::get(), this function returns the coordinate as value, rather than reference.
     * @return `const mu::Vec3` The coordinate primitive's value represented for the base System.
     * @see coord::System
     */
    ...
    /**
     * @brief Migrates the coordinate primitive to another System.
     * @param pSys The System to migrate.
     * @note The migration is performed by calculating the coordinate in the new System     
...
/**
 * @brief A class representing a 3D point in a coordinate system.
 * @see coord::detail::CoordEntry coord::System coord::Vec3
 */
...
/**
 * @brief A class representing a 3D vector in a coordinate system.
 * @see coord::detail::CoordEntry coord::System coord::Pt3
 */
