...
namespace UIPipeline {
	...
	private:
		...
		void MU_CALLCONV addJobUpdate( const DrawEvent* pFirst,
...
namespace Detail {
	extern std::vector<ComPtr<ID3D12Resource>> staticVBQuads;
	extern std::vector<D3D12_VERTEX_BUFFER_VIEW> staticVBViewQuads;
	extern std::map<std::string, u32t> staticVBIdxMapQuads;
	extern ComPtr<ID3D12Resource> staticIBQuad;
	extern D3D12_INDEX_BUFFER_VIEW staticIBViewQuad;
}	// namespace UIPipeline::Detail



#endif // __uiPipeline_HPP
